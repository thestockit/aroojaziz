...
import { products } from "../../data/2pc.js";
...
const TwoPcProducts = () => {
  ...
  const handleWishlist = (e) => {
    e.stopPropagation();
    toggleWishlist(product, product.brand, "2pc");
  ...
  const handleAddToCart = (e) => {
    ...
    for (let i = 0; i < quantity; i++) {
      addToCart(product, product.brand, "2pc");
    }
          ...
          <div className="relative">
            ...
            >
              {products
                ...
                .map((item) => (
                  <Link
                    to={`/chahatcollection/2pc/suit/${item.id}`}
                    key={item.id}
