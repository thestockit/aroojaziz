// src/components/TwoPcCollection.jsx
import React, { useState, useEffect } from "react";
import { FaTimes } from "react-icons/fa";
import { products } from "../data/2pc";
  ...
  return (
    <>
      ...
      <div className="px-4 py-6 text-center">
        <h1 className="text-3xl tracking-wide">SHAHANA 2PC COLLECTION</h1>
      </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                {/* COLORS, SIZE, QUANTITY, FABRIC, DESC, NOTE, SHIPPING */}
                {/* Same structure as main product detail */}
              </div>
            </div>
          </div>
        </div>
